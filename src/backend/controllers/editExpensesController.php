...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!is_int($id) || $id <= 0) {
            ...
            jsonResponse(['error' => 'Datos inválidos. Gasto invalido.'], 400);
            exit();
        }
        ...
        $query = 'UPDATE gastos SET id_etiqueta=:id_etiqueta,cantidad=:cantidad,descripcion=:descripcion,fecha_gasto=:fecha_gasto,fecha_actualizacion=NOW() WHERE id_gasto=:id_gasto';
        ...
        jsonResponse(['success' => true, 'message' => 'Gasto editado con éxito']);
    } else {
